            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-0">
                        ...
                        <textarea name="content" id="blogEditor" class="form-control" rows="16" placeholder="Write your full article here..." required style="resize:vertical;line-height:1.8;">{{ old('content') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
