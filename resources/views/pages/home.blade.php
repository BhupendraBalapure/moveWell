...
@section('content')
        ...
        <div class="container">
            <div class="hero-form">
                ...
                <div class="hero-form-socials">
                    <a href="https://wa.me/917892113380" target="_blank" aria-label="WhatsApp"><i
                            class="fab fa-whatsapp"></i></a>
                    <a href="#" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://www.instagram.com/movewellortho" target="_blank" aria-label="Instagram"><i
        ...
        <div class="container">
            <div class="about-image">
                <div class="about-image-wrapper">
                    <div
                        style="width:100%;height:500px;background:linear-gradient(135deg, var(--primary) 0%, var(--secondary) 100%);display:flex;align-items:center;justify-content:center;color:white;font-size:1.5rem;font-weight:700;">
            ...
            <div class="about-content">
                ...
                <p>Dr. Sahil is a fellowship-trained orthopaedic surgeon known for precision-driven arthroscopic Knee and
                    Shoulder surgeries. With a strong academic foundation and advanced surgical training, he specializes in
                    restoring joint stability, function, and performance.</p>
                <p>He completed his MS in Orthopaedics from the prestigious Jawaharlal Nehru Medical College, Belgaum. He
                    subsequently pursued Fellowship Training in Arthroscopy, Sports Injury & Joint Preservation in Mumbai,
                    followed by a dedicated Fellowship in Advanced Shoulder Surgery.</p>
            ...
            <div class="services-grid">
                @php
                    $categories = [
                        ...
                        'hip' => [
                            'image' => 'category/hip.jpg',
                            'title' => 'Hip Treatment',
                            'desc' =>
                                'Hip arthroscopy for labral tears & impingement, total and partial hip replacement surgery.',
                        ],
                        'elbow' => [
                            'image' => 'category/elbow.jpg',
                            'title' => 'Elbow Treatment',
                            'desc' =>
                                'Tennis elbow, golfer\'s elbow, ligament injuries, fractures, and elbow stiffness management.',
                        ],
                        'ankle' => [
                            'image' => 'category/ankle.jpg',
                            'title' => 'Ankle Treatment',
                            'desc' =>
                                'Ankle sprains, Achilles tendon repair, fractures, arthritis, and chronic instability treatment.',
                        ],
                        'wrist' => [
                            'image' => 'category/wrist.jpg',
                            'title' => 'Wrist Treatment',
                            'desc' =>
                                'Wrist sprains, carpal tunnel syndrome, fractures, De Quervain\'s tenosynovitis, and ganglion cysts.',
                        ],
                    ];
                @endphp

                @foreach ($categories as $catKey => $cat)
                    <a href="{{ route('treatments.category', $catKey) }}" class="service-card img-card stagger-child"
    ...
    <section class="whatsapp-cta section-reveal">
        <div class="container">
            ...
            <a href="https://wa.me/917892113380?text=Hello%20Dr.%20Sahil%2C%20I%20would%20like%20to%20share%20my%20reports."
        ...
        <div class="container">
            ...
            <div class="services-grid">
                @foreach ($mainServices as $service)
                    <a href="{{ route('service.detail', ['category' => $service['category'], 'slug' => $service['slug']]) }}"
                        class="service-card img-card stagger-child" style="text-decoration:none;color:inherit;">
                        <div class="service-card-img">
                            <img src="{{ asset('assets/images/' . ($treatmentImages[$service['slug']] ?? 'category/knee.avif')) }}"
                                alt="{{ $service['title'] }}">
                        </div>
                        <div class="service-card-body">
                            <h3>{{ $service['title'] }}</h3>
                ...
                <div class="testimonial-viewport">
                    <div class="testimonial-track">
                        ...
                        <div class="testimonial-card-premium">
                            ...
                            <p class="testimonial-text">"Dr. Sahil performed my ACL reconstruction surgery. His expertise
                                and care throughout the process was exceptional. I'm back to playing football within 8
                                months!"</p>
                        ...
                        <div class="testimonial-card-premium">
                            ...
                            <p class="testimonial-text">"After years of shoulder pain, Dr. Sahil's rotator cuff repair gave
                                me my life back. His attention to detail and follow-up care is outstanding."</p>
                            <div class="testimonial-author">
                        ...
                        <div class="testimonial-card-premium">
                            ...
                            <p class="testimonial-text">"My mother had knee replacement surgery by Dr. Sahil. She is now
                                walking comfortably without any pain. We are very grateful for his expertise and
                        ...
                        <div class="testimonial-card-premium">
                            ...
                            <p class="testimonial-text">"I had a meniscus tear and was worried about surgery. Dr. Sahil
                                explained everything clearly and the arthroscopic procedure was smooth. Recovered much
                        ...
                        <div class="testimonial-card-premium">
                            ...
                            <p class="testimonial-text">"Dr. Sahil treated my shoulder dislocation issue. After the
                                stabilization surgery, I haven't had a single episode. Truly life-changing treatment!"</p>
                            <div class="testimonial-author">
                        ...
                        <div class="testimonial-card-premium">
                            ...
                            <p class="testimonial-text">"Had hip replacement at age 62. Dr. Sahil made me feel comfortable
                                and confident. Walking pain-free now after years of suffering. Highly recommend!"</p>
                            <div class="testimonial-author">
